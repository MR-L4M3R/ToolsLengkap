...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR    :  MR.L4M3R  "$i"                  "
echo $i""$pu"  WhatsApp  :  +1(507)5790039"$i"              "
echo $i""$pu"  GMAIL     :  sumbercyberteam@gmail.com"$i"   "
echo $i""$pu"  YOUTUBE   :  MR.L4M3RXploit"$i"               "
echo $i""$pu"  INSTAGRAM :  @kepo"$i"               "
echo $i""$pu"  INSTAGRAM :  @kepo"$i"          "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $cy"Terima Kasih sudah mengunakan Tools gue"
sleep 2
echo $i"Silahkan di pakai semoga bermanfaat Buat loe"
sleep 2
...
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { MR.L4M3RXploit }"
exit
fi
